...
<label id="adult">{message name="num-adults"}<input name="qbAdults" class="datainput adultchild" value="{$valQbAdults}" maxlength="2" onkeypress="validateNum(event)" /></label>
<label id="child">{message name="num-children"}<input name="qbChildren" class="datainput adultchild" value="{$valQbChildren}" maxlength="2" onkeypress="validateNum(event)" /></label>
