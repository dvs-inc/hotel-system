<div id="signup-title"><label>{message name="title"}<select name="suTitle">{include file="titles.tpl" selectedVal="{$suTitle}}</select></label></div>
...
<div id="signup-country"><label>{message name="country"}<select name="suCountry" id="dropDownCountry">{include file="countries.tpl" selectedVal="{$suCountry}}</select></label></div>
<div id="signup-email"><label>{message name="email"}<input name="suEmail" class="datainput" value="{$suEmail}"/></label></div>
<div id="signup-password"><label>{message name="password"}<input name="suPassword" type="password" /></label></div>
<div id="signup-confirm-password"><label>{message name="confirm-password"}<input name="suConfirm" type="password" /></label></div>