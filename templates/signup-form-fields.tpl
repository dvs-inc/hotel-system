<div id="signup-title"><label>{message name="title"}<select name="suTitle" class="dropDown">{include file="titles.tpl" selectedVal="{$suTitle}"}</select></label></div>
...
<div id="signup-country"><label>{message name="country"}<select name="suCountry" class="dropDown">{include file="countries.tpl" selectedVal="{$suCountry}"}</select></label></div>
<div id="signup-email"><label>{message name="email"}<input name="suEmail" class="datainput" value="{$suEmail}"/></label></div>
<div id="signup-password"><label>{message name="signup-password"}<input name="suPassword" type="password" class="datainput" /></label></div>
<div id="signup-confirm-password"><label>{message name="signup-confirm-password"}<input name="suConfirm" type="password" class="datainput" /></label></div>