...
<form name="bookingedit" method="post" onsubmit="return validateForm();" action="{$cScriptPath}/Bookings?action=edit&id={$bookingid}">
<div id="constraint">
...
<script type="text/javascript">
	...
	{
	var z="";
	var checkin=document.forms["bookingedit"]["qbCheckin"].value;
	var checkout=document.forms["bookingedit"]["qbCheckout"].value;
	var adultNum=document.forms["bookingedit"]["badults"].value;
