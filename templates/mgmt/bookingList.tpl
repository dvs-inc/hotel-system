...
<th>{message name="booking-start"}</th><th>{message name="booking-end"}</th><th>{message name="booking-promocode"}</th><th>{message name="booking-room"}</th><th id ="link" /><th id="link" /><th id="link" /></tr>
