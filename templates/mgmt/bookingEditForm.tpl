...
<label class="infield">{message name="checkin"}<input id="checkinInput" name="qbCheckin" class="datainput" value="{$bstart}" /><input id="checkinJS" type="button" value=""/> </label>
<label class = "infield">{message name="checkout"}<input id="checkoutInput" name="qbCheckout" class="datainput" value="{$bend}" /><input id="checkoutJS" type="button" value=""/></label>
