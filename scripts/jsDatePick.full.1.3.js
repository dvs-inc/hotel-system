...
/*
	...
	Thank you!
*/
g_jsDatePickImagePath = "/hotel-system/images/img/";
...
JsDatePick.prototype.setConfiguration = function(aConf){
	...
	this.oConfiguration.imgPath			= (g_jsDatePickImagePath.length != null) ? g_jsDatePickImagePath : "/hotel-system/images/img/";
...
JsDatePick.prototype.populateFieldWithSelectedDate = function(){
	JsgetElem(this.oConfiguration.display).value = this.getSelectedDayFormatted();
